...
//
//
//& event-термин "event" (событие) относится к действиям или изменениям, происходящим в браузере или другой среде выполнения JavaScript. События могут быть связаны с пользовательским взаимодействием, таким как клик мыши, нажатие клавиши, перемещение мыши, изменение размера окна и многие другие.
