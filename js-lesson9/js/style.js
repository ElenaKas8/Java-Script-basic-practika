...
// forEach(arr, printArray);
//
// console.log("printElemPow:");
// forEach(arr, printElemPow);
//
// console.log("printEvenElem:");
// forEach(arr, printEvenElem);

//&----------------------------пример функции с задезжкой,и через Callback
//* function first(){
//     setTimeout(() => {
//         console.log(1);
//     }, 500);
...
//&Пример где у кнопки есть 2 события
...
// Вычисляем сумму чисел от 1 до 100
//   for (let i = 1; i <= 100; i++) {
// sum += i;
//   }

// Записываем результат в абзац
//   sumParagraph.textContent = "Сумма чисел от 1 до 100: " + sum;
// });
...
// Заполняем абзацы числами по порядку
