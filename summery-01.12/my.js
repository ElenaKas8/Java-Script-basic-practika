...
// document.body.appendChild(pElem, pElem_2)
// // prepend
// // after
// // before
...
let images = [
  ...
  function nextImage() {
    ...
    if(activeImageIndex >= images.length) { // если индекс выходит за пределы массива с правой стороны то начинаем с первого элемента
      activeImageIndex = 0
    }
